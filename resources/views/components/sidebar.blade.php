...
<aside class="hidden lg:flex lg:flex-col w-64 bg-white text-[#0f1419] shrink-0 h-screen sticky top-0 z-40 border-r border-[#eff3f4]">
    ...
    <div class="p-5 border-b border-[#eff3f4] flex items-center gap-3">
        <div class="w-10 h-10 rounded-full bg-[#1d9bf0] flex items-center justify-center text-white font-black text-xl shadow-md shadow-[#1d9bf0]/20 hover:scale-105 transition-transform cursor-pointer">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
        </div>
        <div>
            <h1 class="font-black text-base tracking-tight text-[#0f1419] flex items-center gap-1.5">
                POS UMKM
                <span class="px-2 py-0.5 rounded-full text-[10px] font-black bg-[#e8f5fd] text-[#1d9bf0] border border-[#bde2f9]">v2.0</span>
            </h1>
            <p class="text-xs text-[#536471] font-semibold">Kasir Event Terintegrasi</p>
        </div>
    </div>
    ...
    <nav class="flex-1 px-3 space-y-1 overflow-y-auto custom-scrollbar py-2">
        ...
        <template x-if="$store.app.currentRole === 'user'">
            <div class="space-y-1">
                ...
                <div class="pt-3 px-4 py-1 text-[11px] font-black uppercase tracking-wider text-[#536471]">Bantuan</div>
        ...
        <template x-if="$store.app.currentRole === 'admin'">
            <div class="space-y-1">
                ...
                <div class="pt-3 px-4 py-1 text-[11px] font-black uppercase tracking-wider text-[#536471]">Bantuan & SOP</div>
