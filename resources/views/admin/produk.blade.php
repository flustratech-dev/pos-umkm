...
<div x-data="{
    ...
    get filteredProducts() {
        ...
        const storeId = isAdmin ? null : $store.app.getCurrentStore()?.id;
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
            <h2 class="text-xl sm:text-2xl font-black text-[#0f1419] tracking-tight">Daftar Produk Semua Warung</h2>
            ...
            <div class="bg-white rounded-2xl border border-[#eff3f4] p-2.5 sm:p-3 hover:border-[#1d9bf0]/40 transition-all flex flex-col justify-between group relative shadow-2xs">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-[#1d9bf0] font-bold mt-1.5 flex items-center gap-1">
                            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                            <span x-text="product.store?.name || 'Tanpa Warung'"></span>
                        </p>
                    </div>
                </div>
        ...
        <div class="flex min-h-full items-end sm:items-center justify-center p-0 sm:p-4 text-left">
            ...
            >
                ...
                <form @submit.prevent="$store.app.saveProduct()" class="space-y-4 mt-4">
                    ...
                    <!-- Warung / Tenant -->
                    <div>
                        <label class="block text-xs font-bold text-[#0f1419] mb-1">Pilih Warung</label>
                        <select 
